...
function Experience() {
  ...
  const biblioteca = {
    encriptador: {
      url: [
        "https://github.com/JuanEstrella1/Encriptador/blob/main/Pictures/Principal.png?raw=true",
    ...
    ToDoList: {
      url: [
        "https://github.com/JuanEstrella1/To-Do-List/blob/main/Pictures/Principal.png?raw=true",
    ...
    fanpage: {
      url: [
        "https://github.com/JuanEstrella1/-Recipe-website/blob/main/Pictures/inicio.png?raw=true",
    ...
    AppBannk: {
      url: [
        "https://github.com/JuanEstrella1/App_Bank/blob/master/Pictures/Inicio.png?raw=true",
      ...
      frameworks: [javaScript, html, css, react],
    },
    FormularioUsuario: {
      url: [
        "https://github.com/JuanEstrella1/Formulario_Usuarios/blob/master/Pictures/Inicio.png?raw=true",
    ...
    FormularioEquipo: {
      url: [
        "https://github.com/JuanEstrella1/Formulario_Equipos/blob/master/Pictures/Inicio.png?raw=true",
      ...
      frameworks: [javaScript, html, react, css],
    },
    socialPage: {
      url: [
        "https://github.com/JuanEstrella1/Social_Page/blob/master/pictures/Inicio.png?raw=true",
    ...
    Ecommerce: {
      url: [
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/Inicio.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/InicioContenido.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/Footer.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/Error%20404.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/TodosProductos.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/AgregarProducto.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/actualizarProducto.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/Login.png?raw=true",
        "https://github.com/JuanEstrella1/E-commerce/blob/master/Pictures/nuevoUsuario.png?raw=true",
      ],
      titulo: "Ecommerce AluraGeek",
      subtexto: "",
      github: "https://github.com/JuanEstrella1/E-commerce",
      enlace: "https://e-commerce-iota-flame.vercel.app/",
      frameworks: [javaScript, html, react, css],
    },
  };
  ...
  return (
    <div className="Experience" id="Proyectos">
      ...
      <ImgIzq biblioteca={biblioteca.Ecommerce} />
